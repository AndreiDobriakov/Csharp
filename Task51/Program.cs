...
// Гулнур Жахина int SumOFMainDiagonalNumbers(int[,] matrix)
// {
// int sum=0;
...
// return sum;
// }
// Гулнур Жахина можно так сделать
// Гулнур Жахина и не будет разницы сколько строк и столбцов
// Артём Вивчаренко интересный подход
// Артём Вивчаренко и работает?
// Гулнур Жахина да
